 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <a href="index3.html" class="brand-link">
         <img src="{{ asset('uploaded/default-avatar.png') }}" alt="AdminLTE Logo"
         ...
         <div class="user-panel d-flex justify-content-between">
             ...
             <div class="info row">
                 <form action="{{ route('logout') }}" method="post">
                     @csrf
                     <button type="submit" class="bg-inherit btn justify-content-center my-0">
                         <img src="{{ asset('application_images/exit.png') }}" title="exit"
                             alt="logout icon" class="brand-image m-auto img-circle elevation-3" style="opacity: .8">
                     </button>
                 </form>
             </div>
...
>>>>>>> register_improve_three_saveINdatabase
